...
<%@ page import="pms.AuditReportDAO" %>
<%@ page import="pms.AuditReport" %>
			...
			<div class="panel-body">
					...
					<form class="form-horizontal" action="AuditReportWrite.jsp">
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-11"> 
						      <input type="password" class="form-control" id="maintechnology" placeholder="요소기술" value="<%=auditReport.getMaintechnology() %>">
						    </div>
						  </div>						  					  
						  ...
						  <div class="form-group"> 
						    <div class="col-sm-offset-1 col-sm-11">
						      ...
						      <a href="AuditReportUpdate.jsp?bbsID=<%= auditReportID %>" class="btn btn-default"> 수정 </a>
